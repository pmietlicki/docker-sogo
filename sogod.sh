...
LD_PRELOAD=$LD_PRELOAD exec gosu sogo /usr/sbin/sogod -WOUseWatchDog $USEWATCHDOG -WONoDetach YES -WOPort 20000 -WOPidFile /var/run/sogo/sogo.pid 2>&1 | tee /var/log/sogo/sogo.log